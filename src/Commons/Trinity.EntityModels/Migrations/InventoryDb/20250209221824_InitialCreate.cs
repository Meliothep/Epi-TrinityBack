        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdSupplier = table.Column<string>(type: "character varying(8)", maxLength: 8, nullable: false),
                    ...
                    NutritionInfo = table.Column<string>(type: "jsonb", nullable: true),
                    NutritionGrade = table.Column<char>(type: "character(1)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Origins_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id");
                });
